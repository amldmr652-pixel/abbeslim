...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'calendar', icon: <Calendar size={20} />, href: '/calendar', hasBadge: true },
  { id: 'notes', icon: <StickyNote size={20} />, href: '/notes', hasBadge: true },
  { id: 'tasks', icon: <CheckSquare size={20} />, href: '/tasks', hasBadge: true },
